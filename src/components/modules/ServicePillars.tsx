...
export default function ServicePillars() {
  return (
    <section className="full-width-line-section border-primary">
      <div className="max-w-[1440px] mx-auto py-24 md:py-32 px-10">
        
        {/* HEADER AREA */}
        <div className="text-center mb-20 animate-fade-in-up">
          <p className="text-eyebrow text-accent text-base mb-4">What We Do</p>
