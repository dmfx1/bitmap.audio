  ...
  return (
    <div className="pt-12 md:pt-20">
      ...
      <div className="max-w-4xl">
        <p className="text-eyebrow text-sm mb-6">Solutions <span className="text-accent ">/ Sonic Branding</span></p>
        <h1 className="text-5xl md:text-6xl font-mono text-white leading-[0.9] tracking-tighter mb-12">
          Define your brand's <br />
          <span className="text-accent animate-pulse font-medium">audio DNA</span>
        </h1>
