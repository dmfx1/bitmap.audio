...
export default function SonicAnalysis() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-48 px-48">
      {/* THE CHALLENGE */}
      <div className="space-y-8">
        ...
        <div className="space-y-6 text-body-muted text-base font-mono leading-relaxed">
          ...
          <p className="text-xl">A thoughtfully crafted sonic brand becomes instantly recognisable, consistently memorable, and emotionally resonant across every touchpoint.</p>
        </div>
      </div>
