          ...
          <div className="container-page relative z-10 flex flex-col min-h-0">
            <div className="flex-1 flex flex-col justify-center min-h-0">
              <div data-hero-pull="sub" className="hero-copy">
                ...
                >
                  We design immersive audio experiences for physical installations and augmented reality experiences to bring experiences to life through the feeling of sound.
                </p>
              </div>
            </div>
            <div data-hero-pull="track" className="hero-copy">
              ...
              >
                <PlayReelButton slug="immersive-audio" />
              </div>
            </div>
          </div>
        </>
