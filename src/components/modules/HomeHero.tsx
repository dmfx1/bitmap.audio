    ...
    <div className="relative w-full max-w-4xl mx-auto flex flex-col items-center text-center">
      <div className="flex flex-col items-center mb-12">
        ...
        <div className="min-h-[1.5em]">
          {step >= 1 && (
            <TypewriterHero text="bitmap.audio" isBrand={true} speed={60} className="font-mono text-4xl md:text-6xl lg:text-7xl font-light text-foreground tracking-tighter" onComplete={() => setStep(2)} />
          )}
        </div>
      </div>
